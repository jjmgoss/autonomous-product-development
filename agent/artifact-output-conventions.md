...
- `artifacts/runs/<run-id>/review-package/` stores the canonical discovery milestone deliverables for that run.
...
Use paths that resolve cleanly either from the repo root or from the manifest location.
